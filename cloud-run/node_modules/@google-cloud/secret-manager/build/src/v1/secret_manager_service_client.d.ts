...
export declare class SecretManagerServiceClient {
     ...
     */
    enableManagedRotation(request?: protos.google.cloud.secretmanager.v1.IEnableManagedRotationRequest, options?: CallOptions): Promise<[
        protos.google.cloud.secretmanager.v1.ISecretVersion,
        (protos.google.cloud.secretmanager.v1.IEnableManagedRotationRequest | undefined),
        {} | undefined
    ]>;
    enableManagedRotation(request: protos.google.cloud.secretmanager.v1.IEnableManagedRotationRequest, options: CallOptions, callback: Callback<protos.google.cloud.secretmanager.v1.ISecretVersion, protos.google.cloud.secretmanager.v1.IEnableManagedRotationRequest | null | undefined, {} | null | undefined>): void;
    enableManagedRotation(request: protos.google.cloud.secretmanager.v1.IEnableManagedRotationRequest, callback: Callback<protos.google.cloud.secretmanager.v1.ISecretVersion, protos.google.cloud.secretmanager.v1.IEnableManagedRotationRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    rotateSecret(request?: protos.google.cloud.secretmanager.v1.IRotateSecretRequest, options?: CallOptions): Promise<[
        protos.google.cloud.secretmanager.v1.ISecretVersion,
        protos.google.cloud.secretmanager.v1.IRotateSecretRequest | undefined,
        {} | undefined
    ]>;
    rotateSecret(request: protos.google.cloud.secretmanager.v1.IRotateSecretRequest, options: CallOptions, callback: Callback<protos.google.cloud.secretmanager.v1.ISecretVersion, protos.google.cloud.secretmanager.v1.IRotateSecretRequest | null | undefined, {} | null | undefined>): void;
    rotateSecret(request: protos.google.cloud.secretmanager.v1.IRotateSecretRequest, callback: Callback<protos.google.cloud.secretmanager.v1.ISecretVersion, protos.google.cloud.secretmanager.v1.IRotateSecretRequest | null | undefined, {} | null | undefined>): void;
    /**
